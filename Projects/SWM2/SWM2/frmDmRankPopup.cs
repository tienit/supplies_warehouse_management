...
namespace VKTIM
{
    public partial class frmDmRankPopup : CommonForm
    {
        ...
        public frmDmRankPopup()
        {
            InitializeComponent();
        }

        private void frmDmRankPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            DMRANKInfo unitInfo = new DMRANKInfo();
            unitInfo.RANK_NAME = txt_data_name.Text;
            unitInfo.RANK_DESCRIPTION = txt_data_description.Text;

            if (_ACTION_TYPE == ACTION_TYPE.AddNew)
            {
                try
                {
                    unitInfo = DMRANKController.Instance().Insert(unitInfo);
                    if (unitInfo != null)
                    {
            ...
            else if (_ACTION_TYPE == ACTION_TYPE.Update)
            {
                try
                {
                    ...
                    DMRANKController.Instance().Update(unitInfo);
                    _OBJECT_ID = unitInfo.ID;
                    //------ Add log -------
