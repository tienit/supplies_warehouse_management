...
{
	return SqlHelper.ExecuteScalar(SqlConnect.ConnectionString, VKTIM_COMPONENT_HT_FORM_INSERT, DB_GetNull(objInfo.FORM_NAME), DB_GetNull(objInfo.FORM_TITLE), DB_GetNull(objInfo.MENU_NAME), DB_GetNull(objInfo.IS_SHOW_DIALOG), DB_GetNull(objInfo.SHORTCUT_KEY), DB_GetNull(objInfo.IS_USED), DB_GetNull(objInfo.FORM_ORDER));
}

public virtual int HT_FORM_Update(HTFORMInfo objInfo)
{
	return SqlHelper.ExecuteNonQuery(SqlConnect.ConnectionString, VKTIM_COMPONENT_HT_FORM_UPDATE, DB_GetNull(objInfo.ID), DB_GetNull(objInfo.FORM_NAME), DB_GetNull(objInfo.FORM_TITLE), DB_GetNull(objInfo.MENU_NAME), DB_GetNull(objInfo.IS_SHOW_DIALOG), DB_GetNull(objInfo.SHORTCUT_KEY), DB_GetNull(objInfo.IS_USED), DB_GetNull(objInfo.FORM_ORDER));
}
