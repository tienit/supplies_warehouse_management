...
public TMUSERSInfo(int ID, string CHR_USERNAME, string CHR_PASSWORD, int INT_USERGROUP, int INT_FACTORY_ID, bool BIT_LOCKED, string CHR_OPERATOR_CODE, string CHR_POSITION, DateTime DAT_DOB, string CHR_ADDRESS, string CHR_MOBILE, string CHR_EMAIL, string CHR_REMARK)
{
	this.ID = ID;
