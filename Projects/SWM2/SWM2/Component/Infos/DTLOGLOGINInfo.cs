...
public DTLOGLOGINInfo(int ID, int INT_USER_ID, string CHR_USERNAME, int INT_USERGROUP, DateTime DAT_CREATED, string CHR_CONTENT, string CHR_DOMAIN, string CHR_MACHINE, string CHR_COM_USER, string CHR_DIRECTORY, int INT_FACTORY_ID, string CHR_FACTORY_NAME, string CHR_REMARK, string CHR_NOTE1, string CHR_NOTE2, string CHR_NOTE3)
{
	this.ID = ID;
