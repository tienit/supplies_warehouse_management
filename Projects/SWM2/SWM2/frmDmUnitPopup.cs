...
namespace VKTIM
{
    public partial class frmDmUnitPopup : CommonForm
    {
        ...
        public frmDmUnitPopup()
        {
            InitializeComponent();
        }

        private void frmDmUnitPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            DMUNITInfo unitInfo = new DMUNITInfo();
            unitInfo.UNIT_NAME = txt_data_name.Text;
            unitInfo.UNIT_SHORT_NAME = txt_data_shortname.Text;
            unitInfo.UNIT_DESCRIPTION = txt_data_description.Text;

            if (_ACTION_TYPE == ACTION_TYPE.AddNew)
            {
                try
                {
                    unitInfo = DMUNITController.Instance().Insert(unitInfo);
                    if (unitInfo != null)
                    {
            ...
            else if (_ACTION_TYPE == ACTION_TYPE.Update)
            {
                try
                {
                    ...
                    DMUNITController.Instance().Update(unitInfo);
                    _OBJECT_ID = unitInfo.ID;
                    //------ Add log -------
