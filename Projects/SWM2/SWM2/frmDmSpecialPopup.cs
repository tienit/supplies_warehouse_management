...
namespace VKTIM
{
    public partial class frmDmSpecialPopup : CommonForm
    {
        ...
        public frmDmSpecialPopup()
        {
            InitializeComponent();
        }

        private void frmDmSpecialPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            DMSPECIALInfo unitInfo = new DMSPECIALInfo();
            unitInfo.SPECIAL_NAME = txt_data_name.Text;
            unitInfo.SPECIAL_DESCRIPTION = txt_data_description.Text;

            if (_ACTION_TYPE == ACTION_TYPE.AddNew)
            {
                try
                {
                    unitInfo = DMSPECIALController.Instance().Insert(unitInfo);
                    if (unitInfo != null)
                    {
            ...
            else if (_ACTION_TYPE == ACTION_TYPE.Update)
            {
                try
                {
                    ...
                    DMSPECIALController.Instance().Update(unitInfo);
                    _OBJECT_ID = unitInfo.ID;
                    //------ Add log -------
