...
namespace VKTIM
{
    public partial class frmDmProductCategoryPopup : CommonForm
    {
        ...
        public frmDmProductCategoryPopup()
        {
            InitializeComponent();
        }

        private void frmDmProductCategoryPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            DMPRODUCTCATEGORYInfo unitInfo = new DMPRODUCTCATEGORYInfo();
            unitInfo.PRODUCTCATEGORY_NAME = txt_data_name.Text;
            unitInfo.PRODUCTCATEGORY_DESCRIPTION = txt_data_description.Text;

            if (_ACTION_TYPE == ACTION_TYPE.AddNew)
            {
                try
                {
                    unitInfo = DMPRODUCTCATEGORYController.Instance().Insert(unitInfo);
                    if (unitInfo != null)
                    {
            ...
            else if (_ACTION_TYPE == ACTION_TYPE.Update)
            {
                try
                {
                    ...
                    DMPRODUCTCATEGORYController.Instance().Update(unitInfo);
                    _OBJECT_ID = unitInfo.ID;
                    //------ Add log -------
